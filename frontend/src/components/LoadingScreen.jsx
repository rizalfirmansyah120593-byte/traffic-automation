  ...
  return <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="loading-overlay">
    <motion.div initial={{ y: 24, scale: .97 }} animate={{ y: 0, scale: 1 }} className="loading-panel">
      ...
      <div className="relative">
        ...
        <div className="mb-6 grid gap-3 sm:grid-cols-2"><div className="rounded-2xl border border-white/10 bg-white/[.04] p-4"><div className="mb-2 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-slate-500"><FaGlobe className="text-cyan-400" /> {t('target')}</div><p className="break-all font-mono text-xs text-slate-200">{url}</p></div><div className="rounded-2xl border border-white/10 bg-white/[.04] p-4"><div className="mb-2 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-slate-500"><FaNetworkWired className="text-blue-400" /> {t('clientIp')}</div><p className="font-mono text-xs text-slate-200">{ip}</p></div></div>
